 ...
 * @author Akane
 */
public class Cagada extends javax.swing.JDialog {

    /**
     * Creates new form RegistroDIalog
     */
    public Cagada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cagada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cagada dialog = new Cagada(new javax.swing.JFrame(), true);
