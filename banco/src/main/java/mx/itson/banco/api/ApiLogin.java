...
import java.net.URL;
import mx.itson.banco.ui.*;

/**
 *
 * @author Akane
 */
public class ApiLogin extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        try {
    // Datos de login que el usuario escribió
    String correo = txtCorreo.getText();  // tu JTextField de correo
    String contrasena = pswContrasena.getText();  // tu JTextField de contraseña

    // Construccion del JSON
    String jsonInputString = "{ \"correo\": \"" + correo + "\", \"contrasena\": \"" + contrasena + "\" }";

    // URL de la API
    URL url = new URL("http://localhost:8080/api/usuarios/login");
    HttpURLConnection con = (HttpURLConnection) url.openConnection();

    // Configurcion de la conexión
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApiLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
